...
import { ActivitiesCommandableHttpServiceV1 } from '../services/version1/ActivitiesCommandableHttpServiceV1';
...
export class ActivitiesServiceFactory extends Factory {
	...
	public static CmdHttpServiceDescriptor = new Descriptor("service-activities", "service", "commandable-http", "*", "1.0");
	...
	constructor() {
		...
		this.registerAsType(ActivitiesServiceFactory.CmdHttpServiceDescriptor, ActivitiesCommandableHttpServiceV1);
